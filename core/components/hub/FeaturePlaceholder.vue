<!--
  ...
  Placeholder réutilisable pour les pages dont la feature est déclarée
  dans le catalogue marketplace mais pas encore implémentée. Affiche le
  titre, un pitch, les bénéfices attendus et un CTA.
-->
<template>
