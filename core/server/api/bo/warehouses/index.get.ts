...
/**
 * GET /api/bo/warehouses — lists warehouses (ps_warehouse) with
 * complete address and stock counters aggregated from ps_stock.
 * Single query: LEFT JOIN ps_address + aggregated stock subquery.
 */
